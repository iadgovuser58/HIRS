...
// --------------------------------------------------------------------------------
    // to delete:
//    /**
//     * Instantiates an anonymous instance of the {@link AttestationCertificateAuthority}.
...
// --------------------------------------------------------------------------------
    ...
    // to delete (no such function)
//    /**
//     * Tests {@link AttestationCertificateAuthority#unwrapIdentityRequest(byte[])}.
//     *
...
//    }
    ...
    public void testDecryptAsymmetricBlob() throws Exception {
        ...
        assertEquals(expected, provisionUtils.decryptAsymmetricBlob(encrypted, encryptionScheme, acaPrivateKey));
    }
